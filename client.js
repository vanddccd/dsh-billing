...
function tideLabel(mode) {
  if (mode === "peak") return "\u9AD8\u5CF0";
  if (mode === "off-peak") return "\u4F4E\u8C37";
  return "\u65E0\u5CF0\u8C37\u6863";
}
function tideTone(mode) {
  if (mode === "peak") return "peak";
  if (mode === "off-peak") return "off";
  return "flat";
}
function TideSplit({ rows, total }) {
  const pct = (r3) => total > 0 ? r3.cost / total * 100 : 0;
  return /* @__PURE__ */ (0, import_react3.createElement)(import_react3.Fragment, null, /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-sect" }, "\u5CF0\u8C37\u62C6\u5206"), rows.length > 1 ? /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-share-wrap billing-pop-share-tight" }, /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-share" }, rows.map((r3) => /* @__PURE__ */ (0, import_react3.createElement)(
    "i",
    {
      key: r3.mode,
      className: `billing-seg billing-seg-${tideTone(r3.mode)}`,
      style: { width: `${pct(r3)}%` }
    }
  ))), /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-lg" }, rows.map((r3) => /* @__PURE__ */ (0, import_react3.createElement)("span", { key: r3.mode }, /* @__PURE__ */ (0, import_react3.createElement)("i", { className: `billing-dot billing-seg-${tideTone(r3.mode)}` }), tideLabel(r3.mode), " ", pct(r3).toFixed(1), "%")))) : null, rows.map((r3) => /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-model", key: r3.mode }, /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-mrow" }, /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-mname" }, tideLabel(r3.mode)), /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-mamt" }, "\xA5", fmtCost(r3.cost))), /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pop-msub" }, r3.tokens.toLocaleString(), " tk"))));
}
function CostPopoverBody({ data }) {
  ...
  const tideTotal = tide.reduce((sum, r3) => sum + r3.cost, 0);
...
function BillingPills(props) {
  ...
  const tideLabel2 = tide.isPeak ? "\u9AD8\u5CF0\u65F6\u6BB5" : "\u4F4E\u8C37\u65F6\u6BB5";
  ...
  return /* @__PURE__ */ (0, import_react3.createElement)("span", { className: "billing-pills" }, /* @__PURE__ */ (0, import_react3.createElement)(
    ...
    "span",
    {
      ...
      tabIndex: 0,
      role: "button",
      "aria-label": aria(tideLabel2, `\u8DDD\u5207\u6362 ${tideRemain}`)
    },
    tideLabel2,
    " \xB7",
    " ",
